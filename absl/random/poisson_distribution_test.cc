...
class PoissonModel {
 public:
  explicit PoissonModel(double mean) : mean_(mean) { __builtin_trap() /* STUB: not implemented */; }

  double mean() const { __builtin_trap() /* STUB: not implemented */; }
  double variance() const { __builtin_trap() /* STUB: not implemented */; }
  double stddev() const { __builtin_trap() /* STUB: not implemented */; }
  double skew() const { __builtin_trap() /* STUB: not implemented */; }
  ...
  CDF InverseCDF(double p) { __builtin_trap() /* STUB: not implemented */; }

  void LogCDF() { __builtin_trap() /* STUB: not implemented */; }
...
void PoissonModel::InitCDF() { __builtin_trap() /* STUB: not implemented */; }
...
class PoissonDistributionZTest : public testing::TestWithParam<ZParam>,
                                 public PoissonModel {
 public:
  PoissonDistributionZTest() : PoissonModel(GetParam().mean) { __builtin_trap() /* STUB: not implemented */; }
...
bool PoissonDistributionZTest::SingleZTest(const double p,
                                           const size_t samples) { __builtin_trap() /* STUB: not implemented */; }
...
std::vector<ZParam> GetZParams() { __builtin_trap() /* STUB: not implemented */; }

std::string ZParamName(const ::testing::TestParamInfo<ZParam>& info) { __builtin_trap() /* STUB: not implemented */; }
...
class PoissonDistributionChiSquaredTest : public testing::TestWithParam<double>,
                                          public PoissonModel {
 public:
  PoissonDistributionChiSquaredTest() : PoissonModel(GetParam()) { __builtin_trap() /* STUB: not implemented */; }
...
void PoissonDistributionChiSquaredTest::InitChiSquaredTest(
    const double buckets) { __builtin_trap() /* STUB: not implemented */; }

template <typename D>
double PoissonDistributionChiSquaredTest::ChiSquaredTestImpl() { __builtin_trap() /* STUB: not implemented */; }
