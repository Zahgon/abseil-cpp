...
class GaussianModel {
 public:
  GaussianModel(double mean, double stddev) : mean_(mean), stddev_(stddev) { __builtin_trap() /* STUB: not implemented */; }
...
class GaussianDistributionTests : public testing::TestWithParam<Param>,
 ...
 public:
  GaussianDistributionTests()
      : GaussianModel(GetParam().mean, GetParam().stddev) { __builtin_trap() /* STUB: not implemented */; }
...
template <typename D>
double GaussianDistributionTests::SingleChiSquaredTest() { __builtin_trap() /* STUB: not implemented */; }
