...
class ExponentialModel {
 public:
  explicit ExponentialModel(double lambda)
      : lambda_(lambda), beta_(1.0 / lambda) { __builtin_trap() /* STUB: not implemented */; }

  double lambda() const { __builtin_trap() /* STUB: not implemented */; }
  ...
  double InverseCDF(double p) { __builtin_trap() /* STUB: not implemented */; }
...
class ExponentialDistributionTests : public testing::TestWithParam<Param>,
 ...
 public:
  ExponentialDistributionTests() : ExponentialModel(GetParam().lambda) { __builtin_trap() /* STUB: not implemented */; }
...
template <typename D>
double ExponentialDistributionTests::SingleChiSquaredTest() { __builtin_trap() /* STUB: not implemented */; }
...
std::vector<Param> GenParams() { __builtin_trap() /* STUB: not implemented */; }

std::string ParamName(const ::testing::TestParamInfo<Param>& info) { __builtin_trap() /* STUB: not implemented */; }
