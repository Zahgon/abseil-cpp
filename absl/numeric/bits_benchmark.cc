...
template <typename T>
static void BM_bit_width(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
...
template <typename T>
static void BM_bit_width_nonzero(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
