...
static inline __attribute__((always_inline)) void _mm_sfence(void) { __builtin_trap() /* STUB: not implemented */; }
...
static inline __attribute__((always_inline)) __m128i _mm_loadu_si128(
    const __m128i *p) { __builtin_trap() /* STUB: not implemented */; }
...
static inline __attribute__((always_inline)) void _mm_stream_si128(__m128i *p,
                                                                   __m128i a) { __builtin_trap() /* STUB: not implemented */; }
...
static inline __attribute__((always_inline)) __m128i _mm_set_epi8(
    ...
    signed char b3, signed char b2, signed char b1, signed char b0) { __builtin_trap() /* STUB: not implemented */; }
#endif  // __aarch64__
