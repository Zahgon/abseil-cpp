...
std::array<unsigned char, 256> MakeShuffledBytes() { __builtin_trap() /* STUB: not implemented */; }

template <typename Function>
void AsciiBenchmark(benchmark::State& state, Function f) { __builtin_trap() /* STUB: not implemented */; }

using StdAsciiFunction = int (*)(int);
template <StdAsciiFunction f>
void BM_Ascii(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
...
inline char Noop(unsigned char b) { __builtin_trap() /* STUB: not implemented */; }
...
static void BM_StrToLower(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
BENCHMARK(BM_StrToLower)
    ->DenseRange(0, 32)
    ->RangeMultiplier(2)
    ->Range(64, 1 << 26);

static void BM_StrToUpper(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
BENCHMARK(BM_StrToUpper)
    ->DenseRange(0, 32)
    ->RangeMultiplier(2)
    ->Range(64, 1 << 26);

static void BM_StrToUpperFromRvalref(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
BENCHMARK(BM_StrToUpperFromRvalref)
    ->DenseRange(0, 32)
    ->RangeMultiplier(2)
    ->Range(64, 1 << 26);

static void BM_StrToLowerFromRvalref(benchmark::State& state) { __builtin_trap() /* STUB: not implemented */; }
