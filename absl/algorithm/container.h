...
template <typename C>
constexpr ContainerIter<C> c_begin(C& c) { return {}; }

template <typename C>
constexpr ContainerIter<C> c_end(C& c) { return {}; }
...
constexpr bool c_linear_search(const C& c, EqualityComparable&& value) { return {}; }
...
constexpr bool c_all_of(const C& c, Pred&& pred) { return {}; }
...
template <typename C, typename Pred>
constexpr bool c_any_of(const C& c, Pred&& pred) { return {}; }
...
template <typename C, typename Pred>
constexpr bool c_none_of(const C& c, Pred&& pred) { return {}; }
...
constexpr std::decay_t<Function> c_for_each(C&& c, Function&& f) { return {}; }
...
constexpr bool c_contains(const Sequence& sequence, T&& value) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence1> c_find_end(
    Sequence1& sequence, Sequence2& subsequence) { return {}; }

// Overload of c_find_end() for using a predicate evaluation other than `==` as
// the function's test condition.
template <typename Sequence1, typename Sequence2, typename BinaryPredicate>
constexpr container_algorithm_internal::ContainerIter<Sequence1> c_find_end(
    Sequence1& sequence, Sequence2& subsequence, BinaryPredicate&& pred) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<C1> c_find_first_of(
    C1& container, const C2& options) { return {}; }

// Overload of c_find_first_of() for using a predicate evaluation other than
// `==` as the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
constexpr container_algorithm_internal::ContainerIter<C1> c_find_first_of(
    C1& container, const C2& options, BinaryPredicate&& pred) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence> c_adjacent_find(
    Sequence& sequence, BinaryPredicate&& pred) { return {}; }
...
template <typename C, typename T>
constexpr container_algorithm_internal::ContainerDifferenceType<const C>
c_count(const C& c, T&& value) { return {}; }
...
template <typename C, typename Pred>
constexpr container_algorithm_internal::ContainerDifferenceType<const C>
c_count_if(const C& c, Pred&& pred) { return {}; }
...
template <typename C1, typename C2, typename BinaryPredicate>
constexpr container_algorithm_internal::ContainerIterPairType<C1, C2>
c_mismatch(C1& c1, C2& c2, BinaryPredicate pred) { return {}; }
...
template <typename C1, typename C2>
constexpr bool c_equal(const C1& c1, const C2& c2) { return {}; }

// Overload of c_equal() for using a predicate evaluation other than `==` as
// the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
constexpr bool c_equal(const C1& c1, const C2& c2, BinaryPredicate&& pred) { return {}; }
...
template <typename C1, typename C2>
constexpr bool c_is_permutation(const C1& c1, const C2& c2) { return {}; }

// Overload of c_is_permutation() for using a predicate evaluation other than
// `==` as the function's test condition.
template <typename C1, typename C2, typename BinaryPredicate>
constexpr bool c_is_permutation(const C1& c1, const C2& c2,
                                BinaryPredicate&& pred) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence> c_search_n(
    Sequence& sequence, Size count, T&& value) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence> c_search_n(
    Sequence& sequence, Size count, T&& value, BinaryPredicate&& pred) { return {}; }
...
c_copy(const InputSequence& input, OutputIterator&& output) { return {}; }
...
c_copy(const InputSequence& input, OutputRange&& output) { return {}; }
...
constexpr container_algorithm_internal::ResultOfRangeToIteratorTransfer<
    C, OutputIterator>
c_copy_n(const C& input, Size n, OutputIterator&& output) { return {}; }
...
constexpr container_algorithm_internal::ResultOfRangeToRangeTransfer<
    C, OutputRange>
c_copy_n(const C& input, Size n, OutputRange&& output) { return {}; }
...
constexpr OutputIterator c_copy_if(const InputSequence& input,
                                   OutputIterator output, Pred&& pred) { return {}; }
...
constexpr BidirectionalIterator c_copy_backward(const C& src,
                                                BidirectionalIterator dest) { return {}; }
...
constexpr container_algorithm_internal::ResultOfRangeToIteratorTransfer<
    C, OutputIterator>
c_move(C&& src, OutputIterator&& dest) { return {}; }
...
constexpr container_algorithm_internal::ResultOfRangeToRangeTransfer<
    C, OutputRange>
c_move(C&& src, OutputRange&& dest) { return {}; }
...
c_transform(const InputSequence1& input1, const InputSequence2& input2,
            OutputIterator&& output, BinaryOp&& binary_op) { return {}; }
...
constexpr std::common_type_t<
    ...
    container_algorithm_internal::ResultOfRangeToRangeTransfer<InputSequence2,
                                                               OutputRange>>
c_transform(const InputSequence1& input1, const InputSequence2& input2,
            OutputRange&& output, BinaryOp&& binary_op) { return {}; }
...
constexpr OutputIterator c_replace_copy(const C& c, OutputIterator result,
                                        T&& old_value, T&& new_value) { return {}; }
...
constexpr OutputIterator c_replace_copy_if(const C& c, OutputIterator result,
                                           Pred&& pred, const T& new_value) { return {}; }
...
c_fill(C&& c, const T& value) { return {}; }
...
constexpr std::enable_if_t<
    container_algorithm_internal::IsPermissibleDestinationRange<C>::value, void>
c_fill_n(C&& c, Size n, const T& value) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<C> c_generate_n(
    C& c, Size n, Generator&& gen) { return {}; }
...
// values.
template <typename C, typename OutputIterator>
constexpr OutputIterator c_unique_copy(const C& c, OutputIterator result) { return {}; }
...
constexpr Iterator c_rotate(C& sequence, Iterator middle) { return {}; }
...
void c_shuffle(RandomAccessContainer& c, UniformRandomBitGenerator&& gen) { __builtin_trap() /* STUB: not implemented */; }
...
OutputIterator c_sample(const C& c, OutputIterator result, Distance n,
                        UniformRandomBitGenerator&& gen) { __builtin_trap() /* STUB: not implemented */; }
...
template <typename C, typename Pred>
constexpr bool c_is_partitioned(const C& c, Pred&& pred) { return {}; }
...
// of equivalents.
template <typename C>
void c_stable_sort(C& c) { __builtin_trap() /* STUB: not implemented */; }

// Overload of c_stable_sort() for performing a `comp` comparison other than the
// default `operator<`.
template <typename C, typename LessThan>
void c_stable_sort(C& c, LessThan&& comp) { __builtin_trap() /* STUB: not implemented */; }
...
template <typename C>
constexpr bool c_is_sorted(const C& c) { return {}; }

// c_is_sorted() overload for performing a `comp` comparison other than the
// default `operator<`.
template <typename C, typename LessThan>
constexpr bool c_is_sorted(const C& c, LessThan&& comp) { return {}; }
...
c_partial_sort_copy(const C& sequence, RandomAccessContainer& result) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(
    Sequence& sequence, const T& value) { return {}; }

// Overload of c_lower_bound() for performing a `comp` comparison other than
// the default `operator<`.
template <typename Sequence, typename T, typename LessThan>
constexpr container_algorithm_internal::ContainerIter<Sequence> c_lower_bound(
    Sequence& sequence, const T& value, LessThan&& comp) { return {}; }
...
constexpr container_algorithm_internal::ContainerIterPairType<Sequence,
                                                              Sequence>
c_equal_range(Sequence& sequence, const T& value) { return {}; }
...
constexpr container_algorithm_internal::ContainerIterPairType<Sequence,
                                                              Sequence>
c_equal_range(Sequence& sequence, const T& value, LessThan&& comp) { return {}; }
...
// 'value'.
template <typename Sequence, typename T>
constexpr bool c_binary_search(const Sequence& sequence, const T& value) { return {}; }
...
constexpr OutputIterator c_merge(const C1& c1, const C2& c2,
                                 OutputIterator result, LessThan&& comp) { return {}; }
...
void c_inplace_merge(C& c,
                     container_algorithm_internal::ContainerIter<C> middle) { __builtin_trap() /* STUB: not implemented */; }
...
void c_inplace_merge(C& c,
                     ...
                     LessThan&& comp) { __builtin_trap() /* STUB: not implemented */; }
...
// container `c2`.
template <typename C1, typename C2>
constexpr bool c_includes(const C1& c1, const C2& c2) { return {}; }

// Overload of c_includes() for performing a merge using a `comp` other than
// `operator<`.
template <typename C1, typename C2, typename LessThan>
constexpr bool c_includes(const C1& c1, const C2& c2, LessThan&& comp) { return {}; }
...
template <
    ...
    typename = std::enable_if_t<
        !container_algorithm_internal::IsUnorderedContainer<C2>::value, void>>
constexpr OutputIterator c_set_union(const C1& c1, const C2& c2,
                                     OutputIterator output, LessThan&& comp) { return {}; }
...
template <typename RandomAccessContainer>
constexpr bool c_is_heap(const RandomAccessContainer& sequence) { return {}; }
...
template <typename RandomAccessContainer>
constexpr container_algorithm_internal::ContainerIter<RandomAccessContainer>
c_is_heap_until(RandomAccessContainer& sequence) { return {}; }

// Overload of c_is_heap_until() for performing heap comparisons using a
// `comp` other than `operator<`
template <typename RandomAccessContainer, typename LessThan>
constexpr container_algorithm_internal::ContainerIter<RandomAccessContainer>
c_is_heap_until(RandomAccessContainer& sequence, LessThan&& comp) { return {}; }
...
constexpr container_algorithm_internal::ContainerIter<Sequence> c_min_element(
    Sequence& sequence, LessThan&& comp) { return {}; }
...
c_minmax_element(C& c) { return {}; }

// Overload of c_minmax_element() for performing `comp` comparisons other than
// `operator<`.
template <typename C, typename LessThan>
constexpr container_algorithm_internal::ContainerIterPairType<C, C>
c_minmax_element(C& c, LessThan&& comp) { return {}; }
...
constexpr bool c_lexicographical_compare(const Sequence1& sequence1,
                                         const Sequence2& sequence2) { return {}; }
...
// permutation.
template <typename C>
constexpr bool c_next_permutation(C& c) { return {}; }

// Overload of c_next_permutation() for performing a lexicographical
// comparison using a `comp` operator instead of `operator<`.
template <typename C, typename LessThan>
constexpr bool c_next_permutation(C& c, LessThan&& comp) { return {}; }
...
// permutation.
template <typename C>
constexpr bool c_prev_permutation(C& c) { return {}; }

// Overload of c_prev_permutation() for performing a lexicographical
// comparison using a `comp` operator instead of `operator<`.
template <typename C, typename LessThan>
constexpr bool c_prev_permutation(C& c, LessThan&& comp) { return {}; }
...
template <typename Sequence, typename T>
constexpr std::decay_t<T> c_accumulate(const Sequence& sequence, T&& init) { return {}; }
...
constexpr std::decay_t<T> c_inner_product(const Sequence1& factors1,
                                          const Sequence2& factors2, T&& sum) { return {}; }
...
constexpr std::decay_t<T> c_inner_product(const Sequence1& factors1,
                                          ...
                                          BinaryOp1&& op1, BinaryOp2&& op2) { return {}; }
...
constexpr OutputIt c_adjacent_difference(const InputSequence& input,
                                         OutputIt output_first, BinaryOp&& op) { return {}; }
