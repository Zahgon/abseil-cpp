...
class ABSL_ATTRIBUTE_VIEW FunctionRef<R(Args...)> { __builtin_trap() /* STUB: not implemented */; };
...
class ABSL_ATTRIBUTE_VIEW
    FunctionRef<R(Args...) const> : private FunctionRef<R(Args...)> { __builtin_trap() /* STUB: not implemented */; };
